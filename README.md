...
You will need to create a firebase account and start a project. To connect to firebase look in the base.js file in the "src" directory. Replace the apiKey, authDomain & the databaseURL. You will need to activate sign-in method's in firebase and connect them to the proper social networks. Facebook is developers.facebook.com - create an app and activate oAuth. Make sure you remember to put in the callback url that firebase give to you. Twitter is at apps.twitter.com - create an app and activate oAuth. Make sure you remember to put in the callback url that firebase give to you.

This project is built with react 16.2.0, react-router 4.2.0 and materialize css.